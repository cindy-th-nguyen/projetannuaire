 ...
 */
final class Version20200613133854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activitethem DROP FOREIGN KEY FK_32160DB33A8ED5A8');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE thematique (id INT AUTO_INCREMENT NOT NULL, acronym VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
