 ...
 */
final class Version20200614011059 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP workphone, CHANGE birthdate birthdate DATETIME NOT NULL, CHANGE tutelle tutelle_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE personne ADD CONSTRAINT FK_FCEC9EFE1847958 FOREIGN KEY (tutelle_id) REFERENCES tutelle (id)');
        $this->addSql('CREATE INDEX IDX_FCEC9EFE1847958 ON personne (tutelle_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP FOREIGN KEY FK_FCEC9EFE1847958');
        $this->addSql('DROP INDEX IDX_FCEC9EFE1847958 ON personne');
        $this->addSql('ALTER TABLE personne ADD workphone VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE birthdate birthdate DATETIME DEFAULT NULL, CHANGE tutelle_id tutelle INT DEFAULT NULL');
